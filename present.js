...
var gift_image_url1 = giftImage1;

var nametag = document.getElementById("nametag");
var present = document.getElementById("present");
var presentImage = document.getElementById("present-image");
var randomIndex = Math.floor(Math.random() * contentCard.length);
...
function init() {
  ...
  document.querySelector('#card .content-card').innerHTML = `${contentCard[randomIndex]}`;
